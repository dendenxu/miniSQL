...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fix_parent.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fix_sibling.eps}
...
算法\ref{alg:fix_tree}列举了修改在插入或删除操作后出现问题节点的B+树的完整过程\footnote{包含分裂节点与合并节点的具体内容}。
